        ...
        <div class="row">
            ...
            <div class="col-8">
                ...
                <div v-else>
                    ...
                    <div id="moods" class="">
                        <button class="button" id="angry"  :class="{ 'selected': selectedMood=== 'angry' }" @click="chooseMood('angry')">
                        ...
                        <button class="button" id="sad" :class="{ 'selected': selectedMood=== 'sad' }" @click="chooseMood('sad')">
                        ...
                        <button class="button" id="neutral" :class="{ 'selected': selectedMood=== 'neutral' }" @click="chooseMood('neutral')">
                        ...
                        <button class="button" id="happy" :class="{ 'selected': selectedMood=== 'happy' }" @click="chooseMood('happy')">
                            ...
                            <h5>Happy</h5></button>
                        <button class="button" id="euphoric" :class="{ 'selected': selectedMood=== 'euphoric' }" @click="chooseMood('euphoric')">
                    ...
                    <div class="d-flex justify-content-center mt-2">
                        <button type="button" class="btn btn-primary mt-2" @click="confirmMood()">
                            Select Mood
                        </button>
                    </div>
                </div>
